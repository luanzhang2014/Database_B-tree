...
class BTLeafNode {
  public:
    ...
    */
    ...
    static const int MAXKEY_NUM = (PageFile::PAGE_SIZE - sizeof(PageId))/(sizeof(RecordId)+sizeof(int)) - 1;
...
class BTNonLeafNode {
  public:
    ...
    */
    ...
    static const int MAXKEY_NUM = (PageFile::PAGE_SIZE - sizeof(PageId))/(sizeof(PageId)+sizeof(int)) - 1;
